...
class CustomDialogVoz extends StatefulWidget {
  final Movimentacoes mov;
  final String categoria;
  final double valor;
  const CustomDialogVoz({Key key, this.mov, this.categoria, this.valor}) : super(key: key);
  @override
  _CustomDialogVozState createState() => _CustomDialogVozState();
}

class _CustomDialogVozState extends State<CustomDialogVoz> {
  ...
  void initState() {
    super.initState();
    _controllerDesc = new TextEditingController(text: widget.categoria);
    _controllerValor = new TextEditingController(text: widget.valor.toString());
    if (widget.mov != null) {
